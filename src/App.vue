  ...
  <div id="app">
    ...
    <navbar
        ...
        :week-contents="[
            ...
            ['Bald verfügbar'],
            ['Aufgabe 1a: Web-Komponenten erstellen', 'Aufgabe 1b: Web-Komponenten erstellen', 'Aufgabe 1c: Web-Komponenten erstellen', 'Aufgabe 1d: Web-Komponenten erstellen'],
            ['Bald verfügbar'],
            ['Bald verfügbar'],
            ['Bald verfügbar'],
            ['Bald verfügbar']]"
        :week-route-links="[
            ...
            ['/'],
            ['/woche8aufgabe1a', '/woche8aufgabe1b', '/woche8aufgabe1c', '/woche8aufgabe1d'],
            ['/'],
            ['/'],
            ['/'],
            ['/']]"
