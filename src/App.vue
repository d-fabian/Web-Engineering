  ...
  <div id="app">
    ...
    <navbar
        ...
        :week-contents="[
            ...
            ['Aufgabe 1: Responsiv mit Flexbox Desktop-First','Aufgabe 2: Responsiv mit Grid Mobile-First', 'Aufgabe 3 Flexbox','Aufgabe 3 Grid','Aufgabe 4'], // todo titel hinzufügen
            ['Bald verfügbar'],
            ['Bald verfügbar'],
            ['Bald verfügbar'],
            ['Bald verfügbar'],
        ...
        :week-route-links="[
            ...
            ['/woche2aufgabe1', '/woche2aufgabe2', '/woche2aufgabe3flex', '/', '/'],
            ['/'],
            ['/'],
            ['/'],
            ['/'],
